...
**Homepage:** <https://github.com/kuberocketci/template-maven-rest.git>
...
* <https://github.com/kuberocketci/template-maven-rest.git>
...
| image.repository | string | `"backend-rest"` |  |
